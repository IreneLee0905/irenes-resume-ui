...
const targetJsPath = path.resolve(__dirname, '../../irenes-resume/src/main/resources/static/js');
const targetIndexPath = path.resolve(__dirname, '../../irenes-resume/src/main/resources/static/index.html');
const cfg = config;
...
fs.copy(path.resolve(__dirname, '../index.html'), targetIndexPath, function (err) {
